...
# secrets module has a method, tokenhex, that will randomly generate a token for us, allowing us to tie our site to a user
import secrets
...
db = SQLAlchemy()  #<-- don't forget your parentheses
...
class Drone(db.Model):
    ...
    price = db.Column(db.Numeric(precision=10, scale=2)) #This is like doing NUMERIC(10,2) in SQL
    camera_quality = db.Column(db.String(150), nullable = True)
    flight_time = db.Column(db.String(199), nullable = True)
...
# string representation of the object is what repr is
    def __repr__(self):
